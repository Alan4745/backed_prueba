...
const ticketsDetectByKmRadius = async (req, res) => {
  try {
    ...
    // Verificar cada tickets para determinar si está dentro del radio de 500 km (500,000 metros)
    ...
    return res.status(200).json({ success: true, ticketsFound: filteredTickets });
  } catch (error) {
    console.error(error);
